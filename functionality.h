...
////////////////////////////////////score validation for count of score/////////////////
            void scorevalidation(int ncount,int& score)
            {
                ...
                score=score+10;
                if(ncount==2)                                                         //when ncount is 2 30 score is added
                score=score+30;
                if(ncount==3)                                                         //when ncount is 3 60 score is added
                score=score+60;
                if(ncount==4)                                                         //when ncount is 4 100 score is added
                score=score+100;
            }
...
/////////////////////////////////////////shadow function///////////////////////////////////////////
            ...
            for(int i=0;i<4;i++)
            {
                if(point_1[i][1]==19)                                       //to remove shadow at line 19 
                llcheck=1;
            }
            if(llcheck==0)
            {   
...
//////////////////////////////////////////////////hard drop////////////////////////////////////////////////
            ...
            void harddrop()
            {
                bool check=true;
                for(int i=0;i<4;i++)
                if(point_1[i][1]==19)                                                //this is for stop falling for 19 line 
                    check=false;
...
//////////////////////////////////////////////////////bomb function////////////////////////////////////         
            ...
            void     bombfun(int& bombcheck,int& bombcheck2,int& bombcheck3,int& xaxis,int& yaxis,float& timer1,float& delay1,int& bombcolor)
            {      
                bombcheck=rand()%65000;                                          //for random generate bomb by picking from 80000
                if(bombcheck==5)
                    bombcheck2=1;                       
                if(timer1>delay1)                                             
                {          
                    ...
                    int x=0,k=0;
                    if(yaxis==19)                                            //this to disapear bomb at 19 row 
                        k=1;
                    if(k==0)
                    { 
...
///////////////////////////////////////////////remove line function//////////////////////////////////////////
            ...
            { 
              ncount=0;   
                for(int i=19;i>0;i--)                                  //for check rows from bottom to top  
                {
